...
import com.polguillen.app.domain.Temporada;
import com.polguillen.app.repository.TemporadaRepository;
...
public class TemporadaResourceTest {
    ...
    private static final LocalDate DEFAULT_YEAR = new LocalDate(0L);
    private static final LocalDate UPDATED_YEAR = new LocalDate();
