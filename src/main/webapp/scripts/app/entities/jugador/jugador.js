    ...
    .config(function ($stateProvider) {
        $stateProvider
            .state('jugador', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'ligabasquetApp.jugador.home.title'
                },
                views: {
                    'content@': {
            ...
            .state('jugador.detail', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'ligabasquetApp.jugador.detail.title'
                },
                views: {
                    'content@': {
            ...
            .state('jugador.new', {
                ...
                onEnter: ['$stateParams', '$state', '$modal', function($stateParams, $state, $modal) {
                    $modal.open({
                        ...
                        resolve: {
                            entity: function () {
                                return {name: null, birthDate: null, canastas: null, asistencias: null, rebotes: null, posicion: null, id: null};
                            }
                        }
