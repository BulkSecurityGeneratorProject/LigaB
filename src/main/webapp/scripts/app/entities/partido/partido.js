    ...
    .config(function ($stateProvider) {
        $stateProvider
            .state('partido', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'ligabasquetApp.partido.home.title'
                },
                views: {
                    'content@': {
            ...
            .state('partido.detail', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'ligabasquetApp.partido.detail.title'
                },
                views: {
                    'content@': {
            ...
            .state('partido.new', {
                ...
                onEnter: ['$stateParams', '$state', '$modal', function($stateParams, $state, $modal) {
                    $modal.open({
                        ...
                        resolve: {
                            entity: function () {
                                return {horaInicio: null, horaFinal: null, puntosLocal: null, puntosVisitantes: null, id: null};
                            }
                        }
